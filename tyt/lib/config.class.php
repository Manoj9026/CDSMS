...
class config{    
    protected static $settings = array(
        'site_name'=>'Centralized Dental Medical Stock Management System',
       ...
       'mysql'=>array('host'=>'localhost','username'=>'user_cdmsms','password'=>'Yt%|h5#$','db'=>'db_cdmsms'),
     //   'mysql'=>array('host'=>'localhost','username'=>'root','password'=>'','db'=>'am_cmsms'),
