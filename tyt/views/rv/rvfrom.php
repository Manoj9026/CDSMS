      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">RV From BMD</li>
          </ol>
        </section>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box-body no-padding">
                        ...
                        <tr>
                            ...
                            <td class=""><?=$value->iv_no?></td>
                            <td><?=$value->iv_date?></td>
                            <td>BMD <?=($value->added_to_stock=='1')?'<label class="badge  pull-right" title="Added to Stock" data-toggle="tooltip"><i class="fa fa-check-circle"></i></label>':''?> </td> 
                            <td class="text-right" >
                              ...
                              <a href="<?=HTTP_PATH.'rv/frombmddetails/'.$value->iv_header_id?>" class="btn btn-sm btn-success" data-toggle="tooltip" title="Add RV details" ><i class="fa fa-eye"></i></a>
