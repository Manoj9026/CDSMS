    ...
    <?php  include VIEWS_PATH.'/include/supper-header.php'; ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1> RV From Other Locations
            <small>All</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="<?=HTTP_PATH?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">RV</li>
            <li class="active">From Other Locations</li>
          </ol>
        </section>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box-body no-padding">
                        ...
                        <tr>
                            ...
                            <td class=""><?=$value->iv_no?></td>
                            <td><?=$value->iv_date?></td>
                            <td><?=$value->station_name?>  <?=($value->added_to_stock=='1')?'<label class="badge  pull-right" title="Added to Stock" data-toggle="tooltip"><i class="fa fa-check-circle"></i></label>':''?> </td> 
                            <td class="text-right" >
                              ...
                              <a href="<?=HTTP_PATH.'rv/rvstationsdetails/'.$value->iv_id?>" class="btn btn-sm btn-success" data-toggle="tooltip" title="Add RV details" ><i class="fa fa-eye"></i></a>
