                   ...
                   if(count($data['ivheader'])==1){?>
                    <div class="box-body">
                        <form class="form-horizontal"  method="post" enctype="multipart/form-data">
                          ...
                          <input type="hidden" value="<?=$data['ivheader'][0]->iv_header_id?>" name="iv_header_id" /> 
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                             ...
                             <label class="col-sm-2">IV From</label>
                                <div class="col-sm-4">
                                  <input type="text" name="iv_from" value="BMD" class="form-control"  <?= ($data['rv_created'])?'disabled="disabled"':''; ?>>
                        ...
                        $total= $i=0; foreach ($data['details'] as $key=>$value ) { $i++;
                         ...
                         ?>
                          <tr>
                            ...
                            <td  class="text-right">
                                <?php if($value->added_to_stock!=1){ ?>
                                <form class="form-horizontal" method="post" enctype="multipart/form-data">   
                                  <input type="hidden" name="add_item" value="1" />
                                  <input type="hidden" name="iv_header" value="<?=$data['ivheader'][0]->iv_header_id?>" />
                                  
                                  <input type="hidden" name="token" value="<?=$token?>" />
                                  <input type="hidden" name="bmd_iv_detail_id" value="<?=$value->bmd_iv_detail_id?>" />
