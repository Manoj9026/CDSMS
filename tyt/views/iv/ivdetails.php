        ...
        <script>
           ...
           function loadItem(cat,select=null){
              ...
              $.each( result, function( key, val ) {
                  ...
                  $('#item_code').append('<option data-color="available" '+se+' data-qty="'+val['qoh']+'" data-unit="'+val['unit']+'" value="'+val['item_code']+'">'+val['item_name']+'('+val['item_bin_no']+') - '+val['qoh']+' '+val['unit']+'</option>');
              });
