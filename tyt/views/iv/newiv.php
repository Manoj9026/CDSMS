                    ...
                    <div class="box-body">
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-9"> 
                                  <select class="select2 form-control" name="iv_to">
                                      <?php foreach ($data['iv_loc'] as $key => $value) {  ?>
                                      <option value="<?=$value->station_id?>"><?=$value->station_name?></option>   
                                  <?php    } ?>
                                  </select> 
                                  
                             <!--   <input type="text" class="form-control" maxlength="150" value="<?=input::get('iv_to');?>" > -->
                              </div>
