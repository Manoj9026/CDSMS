      ...
      <div class="row">
        <div class="col-lg-2"></div>
         <div class="col-lg-4">
            ...
            <p width="350px" align="centere"  style="color:rgb(255, 165, 0); background-color: rgba(0, 0, 0, 0.52);border-radius: 8px; font-size:35px; text-align: center; font-family: sans-serif; text-shadow: 1px 1px 2px black;"  >

            Centralized Dental stock <b>Management System</b> </p> 
                </div>
           <br>  
         </div>
