        ...
        <section class="content">
            ...
            <div class="row"> 
              ...
              <h3 class="box-title"><!--Curent stock  Report --></h3>
                    ...
                    <div class="box-body">
                     <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?=HTTP_PATH.'report/allitems'?>">
              ...
              <div class="col-sm-12">
                <div class="box result box-lime">
                  <div class="box-header">
                    ...
                    <div class="box-tools ">
                      <a href="<?=HTTP_PATH.'report/pdf_allitems/?item_cat_id='.base64_encode(input::get('item_cat_id')).'&&type='.input::get('type')?>" target="_new" class="btn btn-sm btn-danger" data-toggle="tooltip" title="Download PDF as PDF"><i class="fa fa-file-pdf-o"></i></a>
                     <!-- <?=$data['pagination']?> -->
                      </div>
                  </div>
                   ...
                   <table class="table table-hover">
                    <thead>
                     <tr>
                       ...
                       <th class="text-right">IV reserved Qty</th>
                     ...
                     <tbody>
                       ...
                       <tr class="">
                         ...
                         <td class="text-right"><?=$value['issue'].' '.$value['unit']?></td>
