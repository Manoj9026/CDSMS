    ...
    <?php  include VIEWS_PATH.'/include/supper-header.php'; ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1> CRV and IV summary for a  item
            <small></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="<?=HTTP_PATH?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Reports</li>
             <li class="active">CRV and IV summary for a Item</li>
          </ol>
        </section>
                ...
                <div class="box result hide box-lime">
                  ...
                  <div class="box-body no-padding ">
                   ...
                   <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">Total CRV<span id="crv" class="badge badge-primary badge-pill"></span></li>
