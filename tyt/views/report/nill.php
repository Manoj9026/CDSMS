            ...
            <div class="row"> 
                <div class="col-xs-12">
                  ...
                  <div class="box box-lime">
                    ...
                    <div class="box box-lime">
                    <div class="box-header">        
              <h3 class="box-title"><!--All nill drugs --> <small class="pagi"><?=$data['sum']?></small></h3>

                    <div class="box-tools ">
                          <div class="col-lg-2">  
                            <a href="<?=HTTP_PATH.'report/pdf_nill/?station_id='.$data['station_id']?>" target="_new" class="btn btn-sm btn-danger" data-toggle="tooltip" title="Download PDF as PDF"><i class="fa fa-file-pdf-o"></i></a> 
                        </div>
                      <div class="col-lg-10">
                       <!--  <?=$data['pagination']?> -->
                      </div>
                    ...
                    <div class="box-body no-padding">
                        ...
                        <tr>
                            ...
                            <td><?=$value->rol.' '.$value->unit_name?></td>
                            </td>
                        </tr>
                        <?php  } ?></tbody>
                    </table> 
