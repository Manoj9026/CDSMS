        ...
        <section class="content">
            ...
            <div class="row"> 
              ...
              <h3 class="box-title"></h3>
                    ...
                    <div class="box-body  ">
                      <div class="form-group">
                                <label class="col-sm-3 text-right">Location <sup class="text-red">*</sup></label>
                                <div class="col-sm-6">
              ...
              <h3 class="box-title">Expire items withing <?=input::get('date');?> <small class="pagi"><?=$data['sum']?></small></h3>
                    <div class="box-tools ">
                          <div class="col-lg-8">
                          <a href="<?=HTTP_PATH.'report/pdf_expire/?date='.input::get('date').'&&station_id='.$data['station_id']?>" target="_new" class="btn btn-sm btn-danger" data-toggle="tooltip" title="Download PDF as PDF"><i class="fa fa-file-pdf-o"></i></a>   
                        </div>
                    </div>
                  </div>
                    <div class="box-body">   
            				...
            				<table class="table  table-hover ">
            					<tr>
            						<th>Item Name</th>
                                                        <th>Bin Card</th>
                                                        <th>Expire On <i class="fa fa-sort-numeric-asc text-lime"></i></th>
            						<th><?=($data['station_id']==2)?'C':''?>RV No</th>                                                        
            						<th>Batch</th>
            						<th class="text-right"><?=($data['station_id']==2)?'C':''?>RV Quantity</th>
            						...
            						<tr>
            							...
            							<td><?=($data['station_id']==2)?$value->crv_no:$value->rv_no?></td>
            							<td><?=$value->batch_no?></td>
            							<td class="text-right"><?=($data['station_id']==2)?$value->qty:$value->receive_qty;?> <?=$value->unit_name?></td>
