<aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
              <div class="pull-left image"  style=" background-color: #1abc9c; width:50px;height: 50px; border-radius: 25%; padding-left: 2px; padding-top: 3px;">
                  <img src="<?=HTTP_PATH.'public/images/dental-logo-1.png'?>" style="width:45px; height: 45px;" class="img-circle" > 
               <?php   isset($data['pro-face'])?'<img src="'.$data['pro-face'].'" class="img-circle" alt="'.$data['admin']->username.'">':'<span class="bg-yellow" style="font-size:25px; display:inline-block; width:33px; height:33px; text-align:center; border-radius:50%; line-height:100%;" >'.$data['admin']->user_name[0].'</span>'?>
             </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview <?= (App::getRouter()->getController()=='rv')?'active':'';?> ">
              ...
              <ul class="treeview-menu ">
                <li class="<?= ((App::getRouter()->getController()=='rv')&&(App::getRouter()->getAction()=='rvfrom'))?'active':'';?>"><a href="<?=HTTP_PATH?>rv/rvfrom"><i class="fa fa-circle-o text-green"></i> RV From BMD</a></li>
                <li class="<?= ((App::getRouter()->getController()=='rv')&&(App::getRouter()->getAction()=='rvfromstations'))?'active':'';?>"><a href="<?=HTTP_PATH?>rv/rvstations"><i class="fa fa-circle-o text-green"></i> From Other Locations</a></li>
            ...
            <li class="treeview <?= (App::getRouter()->getController()=='bmdiv')?'active':'';?>">
              ...
              <ul class="treeview-menu">
                ...
                <li class="<?= ((App::getRouter()->getController()=='bmdiv')&&(App::getRouter()->getAction()=='instindex'))?'active':'';?>"><a href="<?=HTTP_PATH?>bmdiv/instindex"><i class="fa fa-circle-o text-yellow"></i> All Instruments IV</a></li>
                <li class="<?= ((App::getRouter()->getController()=='bmdiv')&&(App::getRouter()->getAction()=='instnewiv'))?'active':'';?>"><a href="<?=HTTP_PATH?>bmdiv/instnewiv"><i class="fa fa-circle-o text-yellow"></i> New instruments IV</a></li>
             </ul>
            </li>
            <?php } ?>
          ...
          <?php } if($this->data['admin']->station_id==2){  ?>
            ...
            <li class="treeview <?= (App::getRouter()->getController()=='category')?'active':'';?>">
              <a href="#">
                <i class="fa fa-building-o text-navy"></i>
                <span>Category</span>
                <i class="fa fa-angle-left pull-right text-navy"></i>
              </a>
              <ul class="treeview-menu">
                <li class="<?= ((App::getRouter()->getController()=='category')&&(App::getRouter()->getAction()=='index'))?'active':'';?>"><a href="<?=HTTP_PATH?>category"><i class="fa fa-circle-o text-navy"></i> All Categories</a></li>
                  <?php if($data['admin']->privilage_id>1){  ?>
                <li class="<?= ((App::getRouter()->getController()=='category')&&(App::getRouter()->getAction()=='newcategory'))?'active':'';?>"><a href="<?=HTTP_PATH?>category/newcategory"><i class="fa fa-circle-o text-navy"></i> New category</a></li>
              <?php } ?>
