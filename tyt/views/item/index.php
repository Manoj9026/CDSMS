      ...
      <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row"> 
              ...
              <h3 class="box-title"><!--All Items --> <small class="pagi"><?=$data['sum']?></small></h3>
                    ...
                    <div class="box-tools ">
                      ...
                      <div class="col-lg-4">
                          <a href="<?=HTTP_PATH?>item/newitem" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> New</a>
                      </div>
                    </div>  
                </div>
                    ...
                    <div class="box-body no-padding">
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <a href="<?=HTTP_PATH.'item/newitem/'.$value->item_code?>" class="btn btn-sm btn-info" data-toggle="tooltip" title="Edit" ><i class="fa fa-pencil"></i></a>

                                 <?php } if($data['admin']->privilage_id>2){   if($value->active=='1'){ ?>
                                    <a href="<?=HTTP_PATH.'item/?del='.$value->item_code?>" class="btn btn-sm btn-danger" onclick="return confirmDelete();" data-toggle="tooltip" title="Delete" ><i class="fa fa-trash"></i></a>
                                <?php }elseif ($value->active=='0'  && $data['admin']->privilage_id>2) { ?>
                                    <a href="<?=HTTP_PATH.'item/?rep='.$value->item_code?>" class="btn btn-sm btn-success" onclick="return confirm('Do you need to reactivate this item?');" data-toggle="tooltip" title="Reactivate" ><i class="fa fa-undo"></i></a>
                             <?php   } }   ?>
                            </td>
                        </tr>
                        <?php  } ?></tbody>
          ...
          $('#table_search').keyup(function(){
           ...
           if((search).length>2){
              ...
              $.each( result, function( key, val ) {
               ...
               $('#result-table tbody').append('<tr><td>'+i+'</td><td>'+val['item_name']+'</td><td>'+val['cat_name']+'</td><td>'+val['item_bin_no']+'</td><td class="text-right" > <span class="btn btn-sm btn-info" data-html="true" data-toggle="tooltip"  title="<table   class=\'uppercase\' ><tr><td class=\'text-left\'>User</td><td class=\'text-center\'> : </td><td class=\'text-left\'> '+val['service_no']+' '+val['user_rank']+' '+val['name']+'</td></tr><tr><td class=\'text-left\'>IP</td><td class=\'text-center\'> : </td><td class=\'text-left\'> '+val['latest_ip']+'</td></tr><tr><td class=\'text-left\' >Date Time</td><td class=\'text-center\'> : </td><td class=\'text-left\'> '+val['system_dt']+'</td></tr></table>" ><i class="fa fa-info"></i></span> <a href="<?=HTTP_PATH.'item/newitem/'?>'+val['item_code']+'" class="btn btn-sm btn-info" data-toggle="tooltip" title="Edit" ><i class="fa fa-pencil"></i></a> '+btn+'</td></tr>');  i++;
             });  $('.pagi').hide();
             }
           });
