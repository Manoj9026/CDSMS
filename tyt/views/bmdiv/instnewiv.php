      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="<?=HTTP_PATH?>bmdiv">All IV Accessories</a></li>
                ...
                <div class="col-xs-9">
                    ...
                    <div class="box-body">
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              <label class="col-sm-3">Reference<sup class="text-red">*</sup></label>
                              <div class="col-sm-9">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3">
                                    <a href="<?=HTTP_PATH.'bmdiv/instindex'?>" class="btn btn-sm btn-default" >Clear</a>
