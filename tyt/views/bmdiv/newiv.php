                ...
                <div class="col-xs-9">
                    ...
                    <div class="box-body">
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <?=(input::get('iv_header_id'))?'<input type="hidden" value="'.input::get('iv_header_id').'" name="iv_header_id" />':'';?>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-7">
                               <select name="iv_to" class="form-control select2">
                               	<option></option>
                               	<?php foreach ($data['stations'] as $key => $value) { ?>
                               	<option  <?= (input::get('iv_to')==$value->station_id)?'selected="true"':''; ?> value="<?=$value->station_id?>" ><?=$value->station_name?></option>
                              <?php 	} ?>
                               </select>
                              </div>
                              <div class="col-sm-2">
                                  <a target="new" href="<?=HTTP_PATH?>station/newstation"  class="btn bnt-sm btn-success"><i class="fa fa-plus"></i> New Station</a>
                                </div>

                            </div>

                            <div class="form-group">
                              <label class="col-sm-3">Authority</label>
                              <div class="col-sm-9">
                                <textarea class="form-control" name="authority" rows="4"><?=input::get('authority');?></textarea>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3">
                                    <a href="<?=HTTP_PATH.'bmdiv/newiv'?>" class="btn btn-sm btn-default" >Clear</a>
