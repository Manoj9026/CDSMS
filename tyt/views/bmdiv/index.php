            ...
            <div class="row"> 
                <div class="col-xs-12">
                    ...
                    <div class="box-header">
                      ...
                      <div class="col-lg-4">
                          <a href="<?=HTTP_PATH?>bmdiv/newiv" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> New</a>
                      </div>
                    </div> 
                    ...
                    <div class="box-body no-padding">
                        ...
                        <tr>
                            ...
                            <td class="text-right" >
                             ...
                             <a href="<?=HTTP_PATH.'bmdiv/printiv/'.$value->iv_header_id?>" target="_new" class="btn btn-sm btn-default" data-toggle="tooltip" title="Print IV" ><i class="fa fa-print"></i></a>
                            ...
                            <button  onclick="getContent(<?=$value->iv_header_id?>)" class="btn btn-sm btn-warning" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="fa fa-eye"></i></button>
                              ...
                              <a href="<?=HTTP_PATH.'bmdiv/ivdetails/'.$value->iv_header_id?>" class="btn btn-sm btn-success" data-toggle="tooltip" title="Add IV details" ><i class="fa fa-bars"></i></a>
                                ...
                                <a href="<?=HTTP_PATH.'bmdiv/newiv/'.$value->iv_header_id?>" class="btn btn-sm btn-info" data-toggle="tooltip" title="Edit" ><i class="fa fa-pencil"></i></a>
                                 <?php } ?>
                            </td>
                        </tr>
                        <?php  } ?></tbody>
