                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <?php  if($data['admin']->privilage_id>2){  ?>
                                  <a href="<?=HTTP_PATH.'manageuser/inactive/?reset='.$value->user_id?>" class="btn btn-sm btn-warning" title="Reset password" data-toggle="tooltip" ><i class="fa  fa-recycle"></i></a>
                                 <?php  if($value->active=='1'){ ?>
                                    <a href="<?=HTTP_PATH.'manageuser/inactive/?del='.$value->user_id?>" class="btn btn-sm btn-danger" onclick="return confirmDelete();" data-toggle="tooltip" title="Delete" ><i class="fa fa-trash"></i></a>
                                <?php }elseif ($value->active=='0') { ?>
                                    <a href="<?=HTTP_PATH.'manageuser/inactive/?rep='.$value->user_id?>" class="btn btn-sm btn-success" onclick="return confirm('Do you need to reactivate this User?');" data-toggle="tooltip" title="Reactivate" ><i class="fa fa-undo"></i></a>
                             <?php   } }   ?>
                            </td>
                        </tr>
                        <?php  } ?></tbody>
