  ...
  private $_category, $_measure;
     ...
     public function index(){  
      ...
      if(input::get('del') || input::get('rep')){
        ...
        $pagination = new paginator('SELECT item_master.*, item_category.cat_name, user_master.name, user_master.service_no, user_master.user_rank 
            FROM item_master 
        ...
        LEFT JOIN item_category ON item_master.item_cat_id = item_category.item_cat_id
         WHERE item_master.active=? || item_master.active=?  ORDER BY item_master.item_code ASC',array(1,0) );
