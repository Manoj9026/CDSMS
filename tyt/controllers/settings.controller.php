     ...
     public function changestock(){
        ...
        if(token::check(input::get('token'))){ 
        	...
        	$validation->check($_POST,array('item_code'=>array('name'=>'Item','required'=>TRUE, 'min'=>'1','number'=>TRUE),
        		'qoh'=>array('name'=>'Current stock','required'=>FALSE,'number'=>TRUE),
          ...
          //  $currentItem = $this->_item->getItem(array('active','=','1'),array('item_code','=',escape(input::get('item_code'))))[0];
           $currentItem=  $this->_item->getFromQ('SELECT
                                    ...
                                    LEFT JOIN bmd_stock_master ON bmd_stock_master.item_code = item_master.item_code WHERE bmd_stock_master.active=? AND bmd_stock_master.item_code=?',array('1',escape(input::get('item_code'))))[0];
